...
### English
Meet TaskCal's new onboarding — a smooth welcome for every new user. Plus: login fixes, web layout improvements, and a fully synced Spanish translation. A more polished experience, inside and out.

### 繁體中文
全新 Onboarding 引導，讓每位新用戶都能順暢上手 TaskCal。同時修正登入後 theme 切換問題、優化網頁版排版，並完整補全西班牙文翻譯。更精緻的每一個細節。

### Español
Conoce el nuevo Onboarding de TaskCal — una bienvenida fluida para cada nuevo usuario. Además: correcciones de inicio de sesión, mejoras de diseño web y traducción al español completamente sincronizada. Una experiencia más pulida, por dentro y por fuera.
